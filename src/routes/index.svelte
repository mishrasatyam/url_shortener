...
<div class="mx-auto">
    ...
    {:else}
        <form on:submit|preventDefault={handleSubmit} class="mx-10 block mt-20 sm:mt-40 sm:mx-20">
            <input type="url" class="shadow-lg rounded-lg w-full p-4 shadow-gray-300 dark:shadow-none focus:outline-none focus:shadow-orange-400 dark:bg-slate-400 dark:placeholder-slate-200" placeholder="Write url" bind:value={full_url} required>
